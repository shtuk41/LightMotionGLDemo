...
void Wheel::Init()
{
	...
	vec4 array1center = vec4(0,0,glfWidth /2.0,1.0);
	...
	for (int iT = 0; iT < 105; iT+=3)
	{
            ...
            v4AmbientDiffuseColor[iT]				= vec4(1.0,0.0,1.0,1.0);
            v4AmbientDiffuseColor[iT + 1]			= vec4(1.0,0.0,1.0,1.0);
            v4AmbientDiffuseColor[iT + 2]			= vec4(1.0,0.0,1.0,1.0);
            ...
            v4AmbientDiffuseColor[iT + 108]			= vec4(0.0,1.0,0.0,1.0);
            v4AmbientDiffuseColor[iT + 1 + 108]		= vec4(0.0,1.0,0.0,1.0);
            v4AmbientDiffuseColor[iT + 2 + 108]		= vec4(0.0,1.0,0.0,1.0);
            ...
            v4AmbientDiffuseColor[iT + 216]					= (iT / 10) % 2 ? vec4(0.0,0.0,1.0,1.0) : vec4(1.0,0.0,0.0,1.0);
            v4AmbientDiffuseColor[iT + 1 + 216]				= iT % 2 ? vec4(0.0,0.0,1.0,1.0) : vec4(1.0,0.0,0.0,1.0);
            v4AmbientDiffuseColor[iT + 2 + 216]				= iT % 2 ? vec4(0.0,0.0,1.0,1.0) : vec4(1.0,0.0,0.0,1.0);
            ...
            v4AmbientDiffuseColor[iT + 324]			= (iT /10) % 2 ? vec4(0.0,0.0,1.0,1.0) : vec4(1.0,0.0,0.0,1.0);
            v4AmbientDiffuseColor[iT + 1 + 324]		= iT % 2 ? vec4(0.0,0.0,1.0,1.0) : vec4(1.0,0.0,0.0,1.0);
            v4AmbientDiffuseColor[iT + 2 + 324]		= iT % 2 ? vec4(0.0,0.0,1.0,1.0) : vec4(1.0,0.0,0.0,1.0);
    ...
    v4AmbientDiffuseColor[105]				= vec4(1.0,0.0,1.0,1.0);
    v4AmbientDiffuseColor[106]				= vec4(1.0,0.0,1.0,1.0);
    v4AmbientDiffuseColor[107]				= vec4(1.0,0.0,1.0,1.0);
    ...
    v4AmbientDiffuseColor[213]				= vec4(0.0,1.0,0.0,1.0);
    v4AmbientDiffuseColor[214]				= vec4(0.0,1.0,0.0,1.0);
    v4AmbientDiffuseColor[215]				= vec4(0.0,1.0,0.0,1.0);
	...
	v4AmbientDiffuseColor[321]				= vec4(0.0,0.0,1.0,1.0);
    v4AmbientDiffuseColor[322]				= vec4(0.0,0.0,1.0,1.0);
    v4AmbientDiffuseColor[323]				= vec4(0.0,0.0,1.0,1.0);

    v4Vertices[321]							=  vec4(0.0,0.0,glfWidth/2,1.0);
    ...
    v4AmbientDiffuseColor[429]				= vec4(0.0,0.0,1.0,1.0);
    v4AmbientDiffuseColor[430]				= vec4(0.0,0.0,1.0,1.0);
    v4AmbientDiffuseColor[431]				= vec4(0.0,0.0,1.0,1.0);
	...
	v4SpecularColor			= GetSpecularColor();
	glfSpecularExponent		= GetSpecularExponent();
...
//	Inputs:		none
//	Output:		none
//	Purpose:	Logic for spinning wheel
//******************************************************************
void Wheel::Spin(double dVelocity)
{
	rz += GLfloat(dVelocity * 360.0 / (360.0 * glfRadius));
